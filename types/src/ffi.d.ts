...
declare module "tjs:ffi" {
  ...
  export class AdvancedType<T, ST extends SimpleType<T>>
    implements SimpleType<T>
  {
    constructor(
      type: ST,
      conf: {
  ...
  export class CFunction<JRT = any, JAT extends Array<any> = any[]> {
    //TODO: better typing mechanism for Arg types
    constructor(
      symbol: DlSymbol,
      rtype: SimpleType<JRT>,
      argtypes: SimpleType[],
      fixed?: number
    );
    call(...argsJs: JAT): JRT;
  ...
  export function stringToBuffer(s: string): Uint8Array<ArrayBuffer>;
  ...
  export class PointerType<
    ...
    N extends number
  > extends AdvancedType<Pointer<T, N>, PointerType<T, ST, N>> {
  ...
  export class StructType<
    ...
    >
  > extends AdvancedType<Obj, StructType<Obj, FT>> {
  ...
  export class JSCallback<RT, AT extends []> {
    //TODO: better typing mechanism for Arg types
    constructor(
      rtype: SimpleType<RT>,
      argtypes: Array<SimpleType<AT[0]>>,
      func: (...args: AT) => RT
    );
    readonly addr: PointerAddr;
  }
