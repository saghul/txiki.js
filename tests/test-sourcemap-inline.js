...
const bundlePath = path.join(import.meta.dirname, 'helpers', 'sourcemap-inline-bundle.js');
...
assert.ok(!stderrStr.includes('sourcemap-inline-bundle.js'), 'stack trace does not reference bundle file');
