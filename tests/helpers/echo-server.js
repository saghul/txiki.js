// Local echo server that replaces postman-echo.com, httpbin.org,
// websocket-echo.com, cdn.jsdelivr.net, picsum.photos, and wikipedia.com
// for offline testing.
...
// Minimal lodash-like script that defines global _.
...
// Minimal valid 1x1 JPEG (SOI + APP0 + DQT + SOF0 + DHT + SOS + EOI).
...
export function createEchoServer() {
        ...
        fetch: async (req, { server: srv }) => {
            ...
            if (pathname === '/redirect') {
                return new Response(null, {
                    status: 301,
                    headers: {
                        'Location': `http://127.0.0.1:${server.port}/redirect-target`,
                    },
                });
            }
            ...
            // Cookies: return cookies from request.
            if (pathname === '/cookies') {
    ...
    return { server, port: server.port, baseUrl, wsUrl };
}
