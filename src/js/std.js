...
// src/js/stdlib/path.js
var FunctionPrototypeBind = (func, thisArg, ...args) => func.bind(thisArg, ...args);
var StringPrototypeCharCodeAt = (str, i) => str.charCodeAt(i);
var StringPrototypeIndexOf = (str, c) => str.indexOf(c);
var StringPrototypeLastIndexOf = (str, c) => str.lastIndexOf(c);
var StringPrototypeReplace = (str, regexp, val) => str.replace(regexp, val);
var StringPrototypeSlice = (str, i, j) => str.slice(i, j);
var StringPrototypeToLowerCase = (str) => str.toLowerCase();
var CHAR_UPPERCASE_A = 65;
var CHAR_LOWERCASE_A = 95;
...
var platformIsWin32 = tjs.platform === "windows";
