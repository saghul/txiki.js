...
class MessagePort extends EventTarget {
    // The native MessagePort handle backing this port; null once detached.
    #handle;
    #started;
    ...
    postMessage(message, transferOrOptions) {
        ...
        MessagePort.postMessageWithTransfer(this.#handle, message, transferOrOptions, this);
    }
    ...
    start() {
        ...
        this.#handle.start((data, ports, kind) => {
    ...
    static postMessageWithTransfer(handle, message, transferOrOptions, sourcePort) {
...
function createPort(handle) {
    return new MessagePort(kCtor, handle);
}

const postMessageWithTransfer = MessagePort.postMessageWithTransfer;
