/*
 * Ed25519 digital signatures — extracted from TweetNaCl.
 *
 * Only the functions required for Ed25519 sign / verify / seed-based keypair
 * generation are included. Everything else (Salsa20, Poly1305, X25519,
 * secretbox, crypto_box, etc.) has been removed.
 *
 ...
 *
 * The only addition is crypto_sign_seed_keypair(), which is the standard
 * seed-based variant of crypto_sign_keypair (same as libsodium provides).
 */
